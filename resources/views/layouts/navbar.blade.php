            ...
            <div class="page-brand">
                <a class="link" href="index.html">
                    <span class="brand">Admin 
                        &nbsp; <span class="brand-tip">Pannel</span>
                    </span>
                ...
                <ul class="nav navbar-toolbar">
                    ...
                    <li class="dropdown dropdown-notification">
                     ...
                     <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link font-weight-bold" data-toggle="dropdown">
                            <img src="{{ url('/') }}/assets/img/admin-avatar.png" />
                            <span></span>  {{ session()->get('email') }}<i class="fa fa-angle-down m-l-5"></i></a>
                        <ul class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ url('/edit/profile/2') }}"><i class="fa fa-user"></i>Profile</a>
